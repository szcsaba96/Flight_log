        ...
        <div class="in1 dashboard_body">
            ...
            <div>
                ...
                <div class="info info1">
                    <p>
                    <i class="fas fa-info-circle"></i> The scans of your documents improve the process of verifying your flight experience, licences and validity of your flight ratings. Each file submitted will be approved by the staff.
                    </p>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <span class="close">&times;</span>
                        <h4>
                            Graphical (jpg, png, bmp, gif) and pdf formats are allowed. If the document has been scanned to two different files, you should select both of these files. They will be automatically merged to a single PDF file.
                        </h4>
                    </div>
                            ...
                            <div class="modal_table" style="table-layout: unset; ">
                                ...
                                <div class="table-row">
                                    <div class="table-cell">
                                        ...
                                        <input type="file" name="file1" id="file1" style="margin-left: 60px; width: 425px;display: inline-block;" accept="image/jpeg,image/gif,image/png,image/bmp,application/pdf">
                                    </div>
                                </div>
                                ...
                                <div class="table-row">
                                    <div class="table-cell">
                                        ...
                                        <input type="file" name="file2" id="file2" style="margin-left: 60px; width: 425px;display: inline-block;" accept="image/jpeg,image/gif,image/png,image/bmp,application/pdf">
                                    </div>
                                </div>
